...
static ssize_t cap_show(struct dma_chan *c, char *page)
{
	...
	return sprintf(page, "copy%s%s%s%s%s%s%s%s%s\n",
		       ...
		       dma_has_cap(DMA_DIF_INSERT, dma->cap_mask) ? " dif_insert" : "",
		       dma_has_cap(DMA_DIF_STRIP, dma->cap_mask) ? " dif_strip" : "",
		       dma_has_cap(DMA_DIF_UPDATE, dma->cap_mask) ? " dif_update" : "");
