...
#define IOAT_CHANERR_RAID_MASK (IOAT_CHANERR_XOR_P_OR_CRC_ERR | IOAT_CHANERR_XOR_Q_ERR)
#define IOAT_CHANERR_DIF_MASK (IOAT_CHANERR_DIF_RES_ALL_F_ERR | IOAT_CHANERR_DIF_RES_GUARD_TAG_ERR | IOAT_CHANERR_DIF_RES_APP_TAG_ERR | IOAT_CHANERR_DIF_RES_REF_TAG_ERR)
#define IOAT_CHANERR_HANDLE_MASK (IOAT_CHANERR_RAID_MASK | IOAT_CHANERR_DIF_MASK)
